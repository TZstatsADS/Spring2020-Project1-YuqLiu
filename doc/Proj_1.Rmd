...
#### Although there is not a change of the main word used in lyrics, we still cannot say lyrics are not changes. Sometimes the sentiments of a song are not decided by the main word in lyrics, as a result, a sentiments analysis is necessary. In this sentimental analysis, eight sentiments will be considered and the sentiments of a song are determined by the most sentiments that appeared in this song.
...
This part, I use the "bing" package to match the sentiment of each stemmedword in each song, and then to see the sentimental and neutral words usage frequency in each period. 
